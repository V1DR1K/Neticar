...
export function Projects() {
  return <section className="section section-raised" id="proyectos"><div className="container">
    <Reveal className="section-head"><p className="cota cota-violet">Lámina 04 · Trabajo</p><h2 className="headline">Trabajo que parte de una necesidad, no de una plantilla.</h2><p className="lede">Una selección de productos digitales y experiencias construidas desde el problema hasta su uso real. Cada lámina abre una conversación directa.</p></Reveal>
